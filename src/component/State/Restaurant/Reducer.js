import { 
	...
	GET_ALL_RESTAURANTS_REQUEST, GET_ALL_RESTUARNATS_FAILURE, GET_ALL_RESTUARNATS_SUCCESS,
	...
	GET_RESTUARANT_BY_ID_FAILURE, GET_RESTUARANT_BY_ID_REQUEST, GET_RESTUARANT_BY_ID_SUCCESS,
	GET_RESTUARANT_BY_USER_ID_FAILURE, GET_RESTUARANT_BY_USER_ID_REQUEST, GET_RESTUARANT_BY_USER_ID_SUCCESS,
	UPDATE_RESTAURANT_FAILURE, UPDATE_RESTAURANT_REQUEST, UPDATE_RESTAURANT_STATUS_FAILURE,
	UPDATE_RESTAURANT_STATUS_REQUEST, UPDATE_RESTAURANT_STATUS_SUCCESS, UPDATE_RESTAURANT_SUCCESS 
  } from "./ActionType";
  ...
  const restaurantReducer = (state = initialState, action) => {
	switch (action.type) {
	  ...
	  case GET_RESTUARANT_BY_ID_REQUEST:
	  ...
	  case GET_ALL_RESTUARNATS_SUCCESS:
		return {
		  ...state,
		  loading: false,
		  restaurants: action.payload,
		};
	  case GET_RESTUARANT_BY_ID_SUCCESS:
		return {
		  ...state,
		  loading: false,
		  restaurant: action.payload,
		};
	  case GET_RESTUARANT_BY_USER_ID_SUCCESS:
	  ...
	  case GET_ALL_RESTUARNATS_FAILURE:
	  case DELETE_RESTAURANT_FAILURE:
	  case UPDATE_RESTAURANT_FAILURE:
	  case GET_RESTUARANT_BY_ID_FAILURE:
