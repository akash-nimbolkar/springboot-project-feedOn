import { CREATE_CATEGORY_FAILURE, CREATE_CATEGORY_REQUEST, CREATE_CATEGORY_SUCCESS, CREATE_EVENTS_FAILURE, CREATE_EVENTS_REQUEST, CREATE_EVENTS_SUCCESS, CREATE_RESTAURANT_FAILURE, CREATE_RESTAURANT_REQUEST, CREATE_RESTAURANT_SUCCESS, DELETE_EVENTS_FAILURE, DELETE_EVENTS_REQUEST, DELETE_EVENTS_SUCCESS, DELETE_RESTAURANT_FAILURE, DELETE_RESTAURANT_REQUEST, DELETE_RESTAURANT_SUCCESS, GET_ALL_EVENTS_FAILURE, GET_ALL_EVENTS_REQUEST, GET_ALL_EVENTS_SUCCESS, GET_ALL_RESTAURANTS_REQUEST, GET_ALL_RESTUARNATS_FAILURE, GET_ALL_RESTUARNATS_SUCCESS, GET_RESTAURANTS_CATEGORY_FAILURE, GET_RESTAURANTS_CATEGORY_REQUEST, GET_RESTAURANTS_CATEGORY_SUCCESS, GET_RESTAURANTS_EVENTS_FAILURE, GET_RESTAURANTS_EVENTS_REQUEST, GET_RESTAURANTS_EVENTS_SUCCESS, GET_RESTUARANT_BY_ID_FAILURE, GET_RESTUARANT_BY_ID_REQUEST, GET_RESTUARANT_BY_ID_SUCCESS, GET_RESTUARANT_BY_USER_ID_FAILURE, GET_RESTUARANT_BY_USER_ID_REQUEST, GET_RESTUARANT_BY_USER_ID_SUCCESS, UPDATE_RESTAURANT_FAILURE, UPDATE_RESTAURANT_REQUEST, UPDATE_RESTAURANT_STATUS_FAILURE, UPDATE_RESTAURANT_STATUS_REQUEST, UPDATE_RESTAURANT_STATUS_SUCCESS, UPDATE_RESTAURANT_SUCCESS } from "./ActionType";
...
export const getAllRestaurantsAction = ({ token }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({ type: GET_ALL_RESTUARNATS_SUCCESS, payload: data });
            console.log("all restaurants", data);
        } catch (error) {
            console.log("catch error", error);
            dispatch({ type: GET_ALL_RESTUARNATS_FAILURE, payload: error });
        }
    };
};
...
export const getRestaurantByUserId = ({ jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({ type: GET_RESTUARANT_BY_USER_ID_SUCCESS, payload: response.data });
        } catch (error) {
            console.log("catch error ", error);
            dispatch({ type: GET_RESTUARANT_BY_USER_ID_FAILURE, payload: error.message });
        }
    };
};
...
// Corrected createCategoryAction
...
// Corrected getRestaurantsCategory
